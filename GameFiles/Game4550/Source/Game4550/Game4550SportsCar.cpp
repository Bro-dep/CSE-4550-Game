...
AGame4550SportsCar::AGame4550SportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGame4550SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGame4550SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGame4550SportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGame4550SportsWheelRear::StaticClass();
