...
AGame4550OffroadCar::AGame4550OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGame4550OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGame4550OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGame4550OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGame4550OffroadWheelRear::StaticClass();
